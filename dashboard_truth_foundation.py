...
DASHBOARD_METRIC_SPECS = {
    ...
    "final_passed": {
        "owner": "runtime_scanner.final_validated_setups",
        "artifact_path": RUNTIME_DIR / "final_validated_setups.json",
        "field": "validated_setup_count|setups.length",
        "classification": "runtime_critical",
        "fresh_seconds": RUNTIME_FRESH_SECONDS,
        "dependencies": ["scanner_status", "final_decision_engine", "ranking_integrity"],
    },
    "telegram_alerts_this_scan": {
        "owner": "scanner_status",
        "artifact_path": RUNTIME_DIR / "scanner_status.json",
        "field": "alerts_this_scan",
        "classification": "runtime_critical",
        "fresh_seconds": RUNTIME_FRESH_SECONDS,
    ...
    "market_data_status": {
        ...
        "classification": "runtime_critical",
        "fresh_seconds": RUNTIME_FRESH_SECONDS,
        "dependencies": ["ohlc_health", "live_price_status"],
    },
    "ohlc_health": {
        "owner": "data.ohlc_health",
        "artifact_path": RUNTIME_DIR / "ohlc_health.json",
        "field": "status",
        "classification": "runtime_critical",
        "fresh_seconds": RUNTIME_FRESH_SECONDS,
        "dependencies": ["ohlc_cache", "ohlc_refresh_status_diagnostic"],
    },
    ...
    "live_trades_count": {
        "owner": "data.active_trade_store",
        "artifact_path": Path("data") / "journals" / "active_trades.csv",
        "field": "OPEN|ACTIVE|LIVE rows",
        "classification": "runtime_critical",
    ...
    "closed_trade_performance": {
        "owner": "journal.outcome_tracker",
        "artifact_path": Path("data") / "journals" / "trade_outcomes.csv",
        "field": "closed TP/SL outcome rows",
        "classification": "runtime_critical",
        "fresh_seconds": EXTERNAL_READONLY_FRESH_SECONDS,
        "dependencies": ["outcome_tracker", "active_trade_store"],
    },
}
