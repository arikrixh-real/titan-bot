...
DASHBOARD_METRIC_SPECS = {
    ...
    "stocks_checked": {
        "owner": "scanner_filter_truth",
        "artifact_path": RUNTIME_DIR / "scanner_filter_truth_status.json",
        "field": "counters.stocks_checked",
        "classification": "runtime_critical",
        "fresh_seconds": RUNTIME_FRESH_SECONDS,
    ...
    "telegram_alerts_this_scan": {
        "owner": "scanner_filter_truth",
        "artifact_path": RUNTIME_DIR / "scanner_filter_truth_status.json",
        "field": "counters.alerts_this_scan",
        "classification": "runtime_critical",
        "fresh_seconds": RUNTIME_FRESH_SECONDS,
