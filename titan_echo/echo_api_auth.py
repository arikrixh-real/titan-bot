...
PROTECTED_ENDPOINTS = (
    ...
    "/echo/knowledge/modules",
    "/echo/knowledge/engines",
    "/echo/knowledge/architecture",
    "/echo/knowledge/danger",
    "/echo/observer",
    "/echo/alerts",
    ...
    "/chatgpt/custom-gpt/status",
    "/chatgpt/action/catalog",
    "/chatgpt/session/status",
    "/chatgpt/permissions",
    "/chatgpt/conversation/status",
    "/chatgpt/voice/readiness",
    "/chatgpt/relay/readiness",
    "/codex/runner/status",
    "/codex/runner/policy",
