    ...
    def test_runtime_topology_generated_correctly(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            paths = {
                ...
                "scanner_publication_health": root / "scanner_publication_health.json",
                "scanner_runtime_heartbeat": root / "scanner_runtime_heartbeat.json",
                "master_brain_runtime_health": root / "master_brain_runtime_health.json",
                "setup_engine_runtime_health": root / "setup_engine_runtime_health.json",
                "runtime_fallback_resolution": root / "runtime_fallback_resolution.json",
                "master_brain_status": root / "master.json",
                "setup_engine_status": root / "setup.json",
