...
def build_runtime_status(value=None):
    ...
    return {
        ...
        "dashboard_trade_truth": {
            "live_trades_count": trade_lifecycle_health.get("active_live_trades_count"),
            "active_live_trades_count": trade_lifecycle_health.get("active_live_trades_count"),
            "learning_open_trades_count": trade_lifecycle_health.get("learning_open_trades_count"),
            "stale_open_trades_count": trade_lifecycle_health.get("stale_open_trades_count"),
            "closed_tp_sl_trades_count": trade_lifecycle_health.get("closed_tp_sl_trades_count"),
            "manual_reconciliation_required": trade_lifecycle_health.get("manual_reconciliation_required"),
            "trade_lifecycle_reconciliation_path": trade_lifecycle_health.get("trade_lifecycle_reconciliation_path"),
